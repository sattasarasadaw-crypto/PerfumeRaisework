...
ไฟล์นี้ให้คำแนะนำแก่ Codex (Codex.ai/code) เมื่อทำงานกับโค้ดในโปรเจกต์นี้
