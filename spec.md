...
> ไม่ใช่ระบบเต็ม 191 FR / 66 NFR ที่อยู่ในเอกสาร [`docs/`](docs/) (นั่นคือแผนระยะยาวของโครงการ)

**Live URL:** https://sattasarasada-perfume.web.app
**โค้ดจริง:** [`Submission-RAISE-M2-HW1/prototype/`](Submission-RAISE-M2-HW1/prototype/)
...
รายละเอียดสิทธิ์เต็ม: [`ACL.md`](ACL.md) · บังคับใช้จริงที่ [`firestore.rules`](Submission-RAISE-M2-HW1/prototype/firestore.rules)
...
| ⑤ | อธิบายระบบตัวเองได้ | ไฟล์นี้ + [`docs/05-log/`](docs/05-log/) + commit history |
